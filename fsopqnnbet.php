...
define('DOMAIN_ID', "315824");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "10035a428fdb2545aeb2a08f823de53d284160afe100d9fbf7b4776b9ca57261");
define('CREATED_TIMESTAMP', "1533585146");

/**
* The key to store the script in cache, or the name of the local cache file.
*/
define('CACHEKEY', 'prCachedPRIntegrationScript');
/**
...
CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "juicyts.blogspot.com",
));
